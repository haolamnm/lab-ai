...
interface SampleCase {
  ...
  /** True makes the trip a loop: the dropoff becomes an ordinary stop and the
   *  route comes home to the pickup. */
...
export const SAMPLE_CASES: Record<SampleCaseKey, SampleCase> = {
  'two-blocks': {
    ...
    vehicle: 'bike', period: 'offpeak', criterion: 'balanced', optimiseOrder: true, returnToStart: false,
  },
  'cross-town': {
    key: 'cross-town',
  ...
  'rush-hour': {
    ...
    vehicle: 'car', period: 'peak', criterion: 'avoid', optimiseOrder: true, returnToStart: false,
  },
  'after-dark': {
    key: 'after-dark',
    ...
    start: 'A', stops: [], goal: 'T',
    vehicle: 'car', period: 'night', criterion: 'time', optimiseOrder: true, returnToStart: false,
  },
  'alley': {
    key: 'alley',
    name: 'Alley shortcut',
    ...
    vehicle: 'bike', period: 'offpeak', criterion: 'distance', optimiseOrder: true, returnToStart: false,
  },
  'truck-curfew': {
    key: 'truck-curfew',
    name: 'Truck at peak',
