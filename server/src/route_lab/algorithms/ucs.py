...
UCS expands the state with the lowest accumulated cost first. Because Route
Lab's edge costs are non-negative, the first settled state at the goal is an
optimal path for the configured distance, time, congestion, and risk weights.
"""
